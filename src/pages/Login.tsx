...
const Login = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to CityReport. You can now start reporting issues.",
      });
      setIsLoading(false);
      navigate('/my-reports');
    }, 1500);
  ...
  const handleSocialLogin = (provider: string) => {
    toast({
      title: "Social login",
      description: `${provider} login will be available once connected to backend services.`,
    });
  };
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold">Welcome to CityReport</h1>
